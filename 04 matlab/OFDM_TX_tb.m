...
datout_fid = fopen('RTL_OFDM_TX_QPSK_Mod_Re.txt', 'r');
QPSK_Re_rtl = fscanf(datout_fid, '%d ');
fclose(datout_fid);
datout_fid = fopen('RTL_OFDM_TX_QPSK_Mod_Im.txt', 'r');
QPSK_Im_rtl = fscanf(datout_fid, '%d ');
fclose(datout_fid);
Datout_rtl = (QPSK_Re_rtl./2^15) + 1i*(QPSK_Im_rtl./2^15);

datout_fid = fopen('RTL_OFDM_TX_pilot_Mod_Re.txt', 'r');
Pilots_Insert_Re_rtl = fscanf(datout_fid, '%d ');
fclose(datout_fid);
datout_fid = fopen('RTL_OFDM_TX_pilot_Mod_Im.txt', 'r');
...
fclose(datout_fid);
datout_fid = fopen('RTL_OFDM_TX_IFFT_Mod_cnt.txt', 'r');
IFFT_Mod_cnt_rtl = fscanf(datout_fid, '%d ');
fclose(datout_fid);
...
QPSK_Mod_sim = reshape(dat_mod, 1, NC * NS);
